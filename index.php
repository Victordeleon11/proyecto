    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <a href="class.php" class="btn btn-primary px-4">Ingresar a Clases</a>
    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            <div class="col-lg-6 text-center text-lg-left">
                <h4 class="text-white mb-4 mt-5 mt-lg-0">Centro de Aprendizaje</h4>
                <h1 class="display-3 font-weight-bold text-white">Nuevo Enfoque para la Educación</h1>
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <img class="img-fluid mt-5" src="img/1.svg" alt="">
            </div>
        </div>
    </div>
    <!-- Header End -->
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        ...
                        <div class="pl-4">
                            ...
                            <p class="m-0">
                                ¡Patio de juegos! Diseñado para el desarrollo integral.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        ...
                        <div class="pl-4">
                            ...
                            <p class="m-0">Enciende la pasión por la música y el baile,</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        ...
                        <div class="pl-4">
                            <h4>Arte</h4>
                            <p class="m-0">Explora la creatividad, invierte en el arte.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        ...
                        <div class="pl-4">
                            <h4>Transporte</h4>
                            <p class="m-0">Conectamos sueños a través de cada viaje.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        ...
                        <div class="pl-4">
                            <h4>Comida Sana</h4>
                            <p class="m-0">Alimentamos mentes, nutrimos sueños.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="padding: 30px;">
                        ...
                        <div class="pl-4">
                            <h4>Tour Educativo</h4>
                            <p class="m-0">Descubre nuevos horizontes con nuestros tours educativos.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-5 mb-lg-0" src="img/familia.jpg" alt="">
                </div>
                <div class="col-lg-7">
                    <p class="section-title pr-5"><span class="pr-2">Aprende sobre nosotros</span></p>
                    <h1 class="mb-4">La mejor escuela para tus hijos</h1>
                    <p>"Descubre el camino hacia el conocimiento con nuestra escuela, donde la excelencia educativa se fusiona con la calidez guatemalteca. ¡Únete a nosotros y juntos construyamos un futuro lleno de aprendizaje y éxito! 📚🌟 #EducaciónConPasión #SomosTuMejorElección"</p>
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-4">
                            <img class="img-fluid rounded" src="img/familia2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        ...
                        El compromiso del personal docente y la atención individualizada han marcado una diferencia significativa.
                    </div>
                ...
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        <h3 class="fas fa-quote-left text-primary mr-3"></h3>
                        La dedicación de los profesores y el enfoque en valores ha creado un entorno de aprendizaje excepcional.
                    </div>
                    <div class="d-flex align-items-center">
                ...
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        <h3 class="fas fa-quote-left text-primary mr-3"></h3>
                        Esta institución educativa ha superado mis expectativas, la comunicación abierta y constante.
                    </div>
                    <div class="d-flex align-items-center">
                ...
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        <h3 class="fas fa-quote-left text-primary mr-3"></h3>
                        Están siendo formados como individuos integrales, la institución educa no solo con conocimientos, valores.
                    </div>
                    <div class="d-flex align-items-center">
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="about.html"><i class="fa fa-angle-right mr-2"></i>Acerca</a>
                    <a class="text-white mb-2" href="gallery.html"><i class="fa fa-angle-right mr-2"></i>Galeria</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
